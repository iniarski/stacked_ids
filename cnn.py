...
def CNN(cnn_filter_size = 9):
    if os.path.exists(model_path):
        ...
        tf.keras.layers.Reshape((512, 40)),
        tf.keras.layers.Conv1D(128, cnn_filter_size, activation='relu', strides=2, padding='same'),
        ...
        tf.keras.layers.BatchNormalization(),
        tf.keras.layers.Dropout(0.2),
        tf.keras.layers.Conv1D(64, cnn_filter_size, activation='relu', strides=2, padding='same'),
        tf.keras.layers.BatchNormalization(),
        tf.keras.layers.Dropout(0.2),
        tf.keras.layers.Conv1D(64, cnn_filter_size, activation='relu', strides=2, padding='same'),
        tf.keras.layers.BatchNormalization(),
